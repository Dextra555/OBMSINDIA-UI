export const environment = {
  ...
  //  baseUrl: 'http://175.139.216.185:8445/api/',

  //  baseReportUrl:'http://175.139.216.185:8446/'



  //Aura Server configuration 

  // baseUrl: 'http://175.139.216.185:8554/api/',

  // baseReportUrl:'http://175.139.216.185:8555/'
  ...
  //baseReportUrl: 'http://124.217.236.37:8340/'



  //Aura Server configuration 

  //  baseUrl: 'http://124.217.236.37:8449/api/',

  // baseReportUrl: 'http://124.217.236.37:8450/'



  //EastWest Server configuration

  //   baseUrl: 'http://124.217.236.37:8559/api/',

  // baseReportUrl: 'http://124.217.236.37:8560/'
