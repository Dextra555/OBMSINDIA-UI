...
export class NewEmployeeDailyAdvanceComponent implements OnInit {
  ...
  onEmployeeSelected(event: any) {
    ...
    this.employeeDailyForm.patchValue({ EmployeeID: emp.EMP_ID });
    this.employeeSearchCtrl.setValue(emp.EMP_NAME);
    this.employeeChange({ value: emp.EMP_ID });
  }
  ...
  clearEmployeeSelection(source?: string) {
    this.employeeDailyForm.patchValue({ EmployeeID: '' });
